...
public class AutoCompleteDictionaryTrieTester {
	...
	public void testIsWord()
	{
		...
		largeDict.addWord("downhill");
		assertEquals("Testing word only missing last letter.", false, largeDict.isWord("downhil"));		
		assertEquals("Testing word with one extra letter.", false, largeDict.isWord("downhille"));		
